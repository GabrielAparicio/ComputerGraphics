...
__global__ void matrix_mult_shared(int** a, int** b, int** c,int n)
{
        __shared__ int sub_a[THREADS_PER_BLOCK][THREADS_PER_BLOCK];
        __shared__ int sub_b[THREADS_PER_BLOCK][THREADS_PER_BLOCK];
